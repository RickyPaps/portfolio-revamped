  ...
  return (
    <div className="container about-page">
      <div className="text-zone">
        ...
        <p>
          thrive on curiosity, perpetually honing my skills, tackling challenges
          one at a time as I journey through the world of Front-End Development
        </p>
        <p>
          Summing myself up in a single sentence: determined, football fanatic,
